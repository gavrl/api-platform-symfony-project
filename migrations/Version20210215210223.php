 ...
 */
final class Version20210215210223 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__user AS SELECT id, username, name, email, roles, password, password_change_date FROM user');
        $this->addSql('DROP TABLE user');
        $this->addSql('CREATE TABLE user (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, username VARCHAR(30) NOT NULL, name VARCHAR(50) NOT NULL, email VARCHAR(180) NOT NULL, roles CLOB NOT NULL --(DC2Type:simple_array)
        , password VARCHAR(255) NOT NULL, password_change_date INTEGER DEFAULT NULL)');
        $this->addSql('INSERT INTO user (id, username, name, email, roles, password, password_change_date) SELECT id, username, name, email, roles, password, password_change_date FROM __temp__user');
