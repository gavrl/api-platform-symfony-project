...
/**
 * Class Version20210201191513
 * @package DoctrineMigrations
 */
final class Version20210201191513 extends AbstractMigration
{
    /**
     * @return string
     */
    ...
    public function up(Schema $schema) : void
    {
        ...
        , password VARCHAR(255) NOT NULL COLLATE BINARY, username VARCHAR(30) NOT NULL, name VARCHAR(50) NOT NULL)');
